  ...
  const plans = [
    {
      ...
      price: "₹0",
      credits: 100,
      description: "Perfect to beinners starting interview preparation.",
      features: [
    ...
    try {
      ...
      const options = {
        ...
        handler: async function (responce) {
          const verifypay = await axios.post( ServerUrl + "/api/payment/verify",responce, {withCredentials:true})
      ...
      <div className=" max-w-6xl mx-auto mb-14 flex items-start gap-4">
        ...
        <div className=" text-center w-full">
          ...
          <p className=" text-gray-500 mt-3 text-lg">
            Flexible pricing ti match your interview preparation goals.
          </p>
        </div>
      </div>
