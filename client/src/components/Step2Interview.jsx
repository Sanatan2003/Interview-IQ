...
function Step2Interview({interviewData, onFinish}) {
  ...
  useEffect(()=>{
    const loadVoices = () =>{
      ...
      const femaleVoice = voice.find(v => 
  ...
  const submitAnswer = async () => {
    ...
    try {
      ...
      const feedbackText = result.data?.feedback || "No feedback available.";
  ...
  return (
    <div className=' min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center p-4 sm:p-6 justify-center'>
      <div className=' w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
        ...
        <div className=' flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
          ...
          {!isIntroPhase && (<div className=' relative mb-6 bg-gray-50 p-4 selection:p-6 rounded-2xl border border-gray-200 shadow-sm'>
