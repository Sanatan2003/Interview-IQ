...
function Step3Report({ report }) {
  if (!report) {
    return (
      <div className=" min-h-screen flex items-center justify-center">
        <p className=" text-gray-500 text-lg">Loding Report....</p>
      </div>
    );
  }
  ...
  if (finalScore >= 8) {
    ...
    performanceText = "Need minor improvement required.";
  ...
  const downloadPDF = () =>{
    ...
    doc.text("AI inteview Perfomance Report", pageWidth / 2, currentY,{
      align:"center"
    });
    ...
    if(finalScore >= 8){
      advice = 
      "Excellent perfomance. Maintain confidence and structure. Continue refining clarity and supporting answer with strong real-world example.";

    }else if(finalScore >= 5){
      advice = 
      "Good foundation shown. Improve clearity and structure. Pratice delivering concise, confidents answer with strong supporting examples.";
    }else{
      advice = 
      "Significant improvement required. Focus on structure thinking clarity, and confident delivery. Practice answering aloud"
    }
  ...
  return (
    <div className=" min-h-screen bg-linear-to-br from-gray-50 to-green-50 p-4 sm:px-6 lg:px-10 py-8 ">
      ...
      <div className=" grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className=" lg:col-span-2 space-y-6">
          ...
          className=" bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8">
            ...
            <div className=" h-64 marker:h-72 ">
                ...
                className=" bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200 ">
                  ...
                  <div className=" bg-green-50 border border-green-200 p-4 rounded-lg">
                    ...
                    <p className=" text-sm text-gray-700 leading-relaxed">
                      ...
                      ? q.feedback
                    : "No feedback avalible for this question."}
                    </p>
                  </div>
                </div>
              ))}
